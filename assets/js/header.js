// Encontrar e carregar o texto do arquivo html do "header"
...
loadComponents('header-placeholder', '/components/header.html') // Carrega o "header" ao iniciar a página

// Mostrar menu dropdown
function showMenu(id){
    let element = window.document.getElementById(id)                        // Identifica o elemento que foi clicado
